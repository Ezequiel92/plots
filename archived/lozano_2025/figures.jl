...
push!(LOAD_PATH, "./GalaxyInspector/src/")
...
function lozano2025(
    ...
    report_path = mkpath(joinpath(figures_path, "reports"))
    ...
    with_theme(merge(theme_latexfonts(), GalaxyInspector.DEFAULT_THEME)) do
        ...
        Makie.save(joinpath(Au6_MOL_folder, "stellar_metallicity_histogram.png"), f)
        ...
        Makie.save(joinpath(Au6_MOL_folder, "birth_time_histogram.png"), f)
    ...
    with_theme(merge(theme_latexfonts(), GalaxyInspector.DEFAULT_THEME)) do
        ...
        Makie.save(joinpath(Au6_MOL_folder, "gas_evolution_inside_40kpc.png"), f)
    ...
    with_theme(merge(theme_latexfonts(), GalaxyInspector.DEFAULT_THEME)) do
        ...
        Makie.save(
            joinpath(Au6_MOL_folder, "gas_density_and_fractions_profiles.png"),
            f,
        )
    ...
    with_theme(current_theme) do
        ...
        Makie.save(joinpath(figures_path, "comparison/mass_evolution.png"), f)
